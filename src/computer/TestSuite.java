...
public class TestSuite extends Utility {
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Ravina");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Pansuriya");
        sendTextToElement(By.id("BillingNewAddress_Email"), "ravinapansuriya@gmail.com");
