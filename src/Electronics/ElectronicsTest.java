...
public class ElectronicsTest extends Utility {
    ...
    public void verifyThatTheProductAddedSuccessfullyAndPlaceOrderSuccessfully() throws InterruptedException {
        ...
        sendTextToElement(By.id("FirstName"), "Ravina");
        sendTextToElement(By.id("LastName"), "Pansuriya");
        sendTextToElement(By.id("Email"), "ravina001@gmail.com");
        sendTextToElement(By.id("Password"), "Ravina@12345");
        sendTextToElement(By.id("ConfirmPassword"), "Ravina@12345");
        ...
        sendTextToElement(By.id("BillingNewAddress_Address1"), "week street");
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "BN177JW");
        sendTextToElement(By.id("BillingNewAddress_PhoneNumber"), "+4478657488448");
        ...
        sendTextToElement(By.id("CardholderName"), "Ravina Pansuriya");
        //card numnber
